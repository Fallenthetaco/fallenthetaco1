...
const errorBot = new Discord.WebhookClient('529091044160176138529091044160176138', '1vGxl9XVgWi1GiCSZtBq-eIaG4OAP6L5q9W4Klf7ENghtTD4GVM2-LJ-WvaKHcWjXGzO');
    ...
    async run(client, message, args) {
        ...
        if (args[0] === "play") {
            ...
            const webhook = new Discord.RichEmbed()
                .setColor('#36393E')
                .setFooter(`Server: ${message.guild.name} (${message.guild.id})`)
                .setDescription(`${message.author.tag} used the **stop** command`)
            mentionHook.send(webhook);

            const {
                voiceChannel
            } = message.member;
            if (!voiceChannel) return message.channel.send('You need to be in a voice channel for me to play music!');
            const serverQueue = queue.get(message.guild.id);
            if (!serverQueue) return message.channel.send('There is nothing playing so I can\'t stop it for you.');
            serverQueue.songs = [];
            ...
            const webhook = new Discord.RichEmbed()
                .setColor('#36393E')
                .setFooter(`Server: ${message.guild.name} (${message.guild.id})`)
                .setDescription(`${message.author.tag} used the **repeat** command`)
            mentionHook.send(webhook);
            try {
            ...
            const webhook = new Discord.RichEmbed()
                .setColor('#36393E')
                .setFooter(`Server: ${message.guild.name} (${message.guild.id})`)
                .setDescription(`${message.author.tag} used the **skip** command`)
            mentionHook.send(webhook);
            const {
                voiceChannel
            } = message.member;
            if (!voiceChannel) return message.channel.send('You need to be in a voice channel for me to play music!');
            const serverQueue = queue.get(message.guild.id);
            if (!serverQueue) return message.channel.send('There is nothing playing so I can\'t skip it for you.');
            ...
            const webhook = new Discord.RichEmbed()
                .setColor('#36393E')
                .setFooter(`Server: ${message.guild.name} (${message.guild.id})`)
                .setDescription(`${message.author.tag} used the **pause** command`)
            mentionHook.send(webhook);
            ...
            const webhook = new Discord.RichEmbed()
                .setColor('#36393E')
                .setFooter(`Server: ${message.guild.name} (${message.guild.id})`)
                .setDescription(`${message.author.tag} used the **resume** command`)
            mentionHook.send(webhook);
            const sameIDFail = new Discord.RichEmbed()
                .setColor('#36393E')
                .setDescription('You are not in the same voice channel as I am in.');
            ...
            const webhook = new Discord.RichEmbed()
                .setColor('#36393E')
                .setFooter(`Server: ${message.guild.name} (${message.guild.id})`)
                .setDescription(`${message.author.tag} used the **queue** command`)
            mentionHook.send(webhook);
            try {
        ...
        `);
            ...
            const webhook = new Discord.RichEmbed()
                .setColor('#36393E')
                .setFooter(`Server: ${message.guild.name} (${message.guild.id})`)
                .setDescription(`${message.author.tag} used the **info** command`)
            mentionHook.send(webhook);
            try {
                const serverQueue = queue.get(message.guild.id);
                const connectFail = new Discord.RichEmbed()
