...
exports.default = (opts) => __awaiter(this, void 0, void 0, function* () {
    ...
    const res = yield shrinkwrapToDepGraph(filteredShrinkwrap, opts.force ? null : currentShrinkwrap, Object.assign({}, opts, { defaultRegistry: opts.registries.default, importerIds: opts.importers.map((importer) => importer.id), prefix: shrinkwrapDirectory, skipped,
        virtualStoreDir }));
