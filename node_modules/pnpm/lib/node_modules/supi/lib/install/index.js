...
function installInContext(importers, ctx, opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { dependenciesTree, outdatedDependencies, resolvedImporters, resolvedPackagesByPackageId, wantedToBeSkippedPackageIds, } = yield resolve_dependencies_1.default({
            currentShrinkwrap: ctx.currentShrinkwrap,
